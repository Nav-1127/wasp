  ...
  return (
    <div className="pt-24 pb-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 text-black text-sm leading-relaxed">
          <h1 className="text-3xl font-black mb-2" style={{ fontFamily: "Arial, sans-serif" }}>
            TERMS OF SERVICE
          </h1>
          <p className="text-gray-500 mb-8 text-sm font-semibold">Last updated April 18, 2026</p>
          ...
          <Section title="9. CONTACT">
            <p>Questions about these Terms? Contact us at <a href="mailto:waspprivacy@gmail.com" className="text-blue-600 underline">waspprivacy@gmail.com</a>.</p>
          </Section>
        </div>
      </div>
    </div>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="mb-8">
      <h2 className="text-base font-bold text-black mb-3" style={{ fontFamily: "Arial, sans-serif" }}>
        {title}
      </h2>
      {children}
    </section>
